...
- 原书：[Learn Rust With Entirely Too Many Linked Lists](https://rust-unofficial.github.io/too-many-lists/index.html)
- 作者：[Aria Desires, Gankra](https://github.com/Gankra)
- 中文翻译：[shenngw1127](https://github.com/shenngw1127)
- [书籍源代码](https://github.com/rust-unofficial/too-many-lists/)
- [示例源代码](https://github.com/rust-unofficial/too-many-lists/tree/master/lists)
- [正式源代码](https://github.com/contain-rs/linked-list)
- Rust环境
  - 原书使用稳定版：cargo 1.31.0 ~ cargo 1.55.0 (Rust 2018 edition)
  - 原书使用夜间版：rust version 1.60.0-nightly (777bb86bc 2022-01-20)
  - 原书使用操作系统：Windows
  - 翻译使用稳定版：cargo 1.77.1 (e52e36006 2024-03-26)
  - 翻译使用夜间版：rust version 1.69.0-nightly (065852def 2023-02-13)
  - 翻译使用操作系统：MacOS 11
